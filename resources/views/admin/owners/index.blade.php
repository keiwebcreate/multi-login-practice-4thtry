                                        ...
                                        @foreach ($owners as $owner)
                                            <tr>
                                                ...
                                                <td class="md:px-4 py-3">
                                                    <button type="button"
                                                        class=" text-white bg-red-300 border-0 py-2 px-4 focus:outline-none hover:bg-red-600 rounded "
                                                        onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id]) }}'">編集</button>
                                                </td>
                                                <td class="md:px-4 py-3">
                                                    <form id="delete_{{ $owner->id }}"
                                                        ...
                                                        href="#"
                                                            class=" text-white bg-blue-300 border-0 py-2 px-4 focus:outline-none hover:bg-blue-600 rounded ">削除</a>
                                                    </form>
                                                </td>
                                            </tr>
                                        @endforeach
